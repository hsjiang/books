...
abstract class BaseAdapter<T, VH : BaseViewHolder<*>>(protected var mContext: Context, items: MutableList<T>?) : RecyclerView.Adapter<VH>() {
    ...
    open fun replaceAll(items: MutableList<T>?) {
        removeAll()
        addAll(items)
